...
const { scrapeLink } = require('./scraper/link');
const { generateEmbedding } = require('./ai/embedder');
const { classifyContent } = require('./ai/classifier');
const { checkDuplicate } = require('./ai/dedup');
const { requireSupabase } = require('../db/supabase');
...
async function runPipeline({ reelUrl, linkUrl, notes = '', title: titleOverride, summary: summaryOverride, save = false, userId }) {
